...
H.264 encoding, ultra low latency - high density, for resolutions up to 1080p60 (Consult the :ref:`Tuning Transcode Latency <latency-tuning>` section for more details)::
...
H.264 encoding, ultra low latency - low density, for resolutions up to 4kp60 (Consult the :ref:`Tuning Transcode Latency <latency-tuning>` section for more details)::
