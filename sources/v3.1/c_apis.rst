...
Examples of how to perform these two steps in order to initialize an application can be found in the :url_to_xma_apps:`common/src/xlnx_xrm_utils.c` file which is shared by all XMA sample applications.
