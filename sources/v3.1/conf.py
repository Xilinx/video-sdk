...
extlinks = {
    # For public repo
    'url_to_repo': ('https://github.com/Xilinx/video-sdk/blob/v3.1/%s', '%s'),
    'url_to_repo_folder': ('https://github.com/Xilinx/video-sdk/tree/v3.1/%s', '%s'),
...
edit_on_github_branch = 'gh-pages'
...
# Enable this to add the 'View page source' link at the top of each page
...
man_pages = [
    (master_doc, 'video-sdk', 'Xilinx Video SDK',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'video-sdk', 'Xilinx Video SDK', author, 'Xilinx', '', ''),
]
