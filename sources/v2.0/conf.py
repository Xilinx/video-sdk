...
extlinks = {
    'url_to_repo': ('https://github.com/Xilinx/video-sdk/blob/v2.0/%s', ''), 
    'url_to_repo_folder': ('https://github.com/Xilinx/video-sdk/tree/v2.0/%s', ''), 
    'url_to_examples': ('https://github.com/Xilinx/video-sdk/blob/v2.0/%s', ''), 
    'url_to_xma_apps': ('https://github.com/Xilinx/video-sdk/blob/v2.0/examples/xma/%s', 'examples/xma/%s'),                  
}
