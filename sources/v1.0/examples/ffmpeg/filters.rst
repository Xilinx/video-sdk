...
Video Rotation
==============
- Example script: :url_to_examples:`examples/ffmpeg/filters/01_rotate_video.sh`
...
Logo Overlay
============
- Example script: :url_to_examples:`examples/ffmpeg/filters/02_logo_overlay.sh`
...
Crop and Zoom
=============
- Example script: :url_to_examples:`examples/ffmpeg/filters/03_crop_zoom.sh`
...
Video Composition
=================
- Example script: :url_to_examples:`examples/ffmpeg/filters/04_multi_comp.sh`
