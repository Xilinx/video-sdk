...
The |SDK| is a complete software stack allowing users to seamlessly leverage the hardware accelerated features of Xilinx video codec units such as the ones available on Alveo U30 cards. It includes the following elements:
...
* Simultaneous encoding and decoding of up to 48 streams with a maximum aggregated bandwidth of two 3840x2160\@60 fps per card
