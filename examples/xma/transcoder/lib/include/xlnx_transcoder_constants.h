...
#define XLNX_ENC_LINE_ALIGN(x, LINE_SIZE)                                      \
    (((((size_t)x) + ((size_t)LINE_SIZE - 1)) & (~((size_t)LINE_SIZE - 1))))
...
typedef enum { DECODER_ID_H264 = 0, DECODER_ID_HEVC } XlnxDecoderCodecID;
