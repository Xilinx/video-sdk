...
#define SCALER_APP_LOG_ERROR(msg...) \
            xma_logmsg(XMA_ERROR_LOG, XLNX_SCALER_APP_MODULE, msg)
#define SCALER_APP_INFO_LOG(msg...) \
            xma_logmsg(XMA_INFO_LOG, XLNX_SCALER_APP_MODULE, msg)
...
#define SCALER_APP_SUCCESS     XMA_SUCCESS
#define SCALER_APP_ERROR       XMA_ERROR
