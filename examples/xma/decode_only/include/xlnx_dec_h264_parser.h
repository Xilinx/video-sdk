 ...
 * under the License.
 */
#ifndef _INCLUDED_H264_PARSER_H_
#define _INCLUDED_H264_PARSER_H_
...
Parameters:
    ...
    parsedata: structure containing latest sps, pps, and previous slice data
    retoffset: returns the offset of the end of the next access unit
Return:
