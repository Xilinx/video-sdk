...
def main():
    ...
    for n in range(0, num_segments_attempted):
        ...
        transcode_cmd = "gst-launch-1.0 filesrc location=" + inputfile + \
                        " ! matroskademux ! " + input_parser + " ! vvas_xvcudec  dev-idx="+str(device_id)+" ! queue ! " \
                        "vvas_xvcuenc dev-idx="+str(device_id)+" target-bitrate="+ str(bitrate) +" max-bitrate="+ str(bitrate) + " " + encode_options + \
