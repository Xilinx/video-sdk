...
codec_type1=`gst-discoverer-1.0 $2 | grep "video codec:" | cut -d":" -f2 | awk '{print $1;}'`
codec_type2=`gst-discoverer-1.0 $3 | grep "video codec:" | cut -d":" -f2 | awk '{print $1;}'`
codec_type3=`gst-discoverer-1.0 $4 | grep "video codec:" | cut -d":" -f2 | awk '{print $1;}'`
codec_type4=`gst-discoverer-1.0 $5 | grep "video codec:" | cut -d":" -f2 | awk '{print $1;}'`
echo $container
echo $codec_type
...
! queue
! vvas_xvcuenc  dev-idx=$di ! h264parse
! qtmux
